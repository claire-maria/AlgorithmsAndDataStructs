...
class Collinear {
	 ...
	 *         ----------------------------------------------------------
	 *
	 *         Experimental Performance: ------------------------- Write the running
	 *         time of the algorithm when run with the following input sizes
	 * 
	 *         Input Size N Running Time (sec) ------------------------------------
	 *         1000 TODO 2000 TODO 4000 TODO
	 *
	 ...
	 *         b = TODO a = TODO
	 *
	 *         What running time do you predict using your results for input size
	 *         5000? What is the actual running time you get with such an input?
	 *         What is the error in percentage?
	 *
	 *         Error = ( (Actual time) - (Predicted time) ) * 100 / (Predicted time)
	 *
	 *         Input Size N Predicted Running Time (sec) Actual Running Time (sec)
	 *         Error (%)
	 *         ------------------------------------------------------------------------------------------------
	 *         5000 TODO TODO TODO
	 * 
	 ...
	 *
	 *         Experimental Performance: ------------------------- Measure the
	 *         running time of the algorithm when run with the following input sizes
	 * 
	 *         Input Size N Running Time (sec) ------------------------------------
	 *         1000 TODO 2000 TODO 4000 TODO 5000 TODO
	 *
	 *
	 *         Compare Implementations: ------------------------ Show the sppedup
	 *         achieved by this method, using the times you got from your
	 *         experiments.
	 *
	 *         Input Size N Speedup = (time of countCollinear)/(time of
	 *         countCollinearFast)
	 *         ---------------------------------------------------------------------------------
	 *         1000 TODO 2000 TODO 4000 TODO 5000 TODO
	 *
	 ...
	 *         model, give the performance of your algorithm. Explain your answer.
	 *
	 *         Performance: TODO
	 *
	 *         Explanation: TODO
